...
import com.example.trialassignment.adapter.MerchantListAdapter;
...
public class MerchantFragment extends Fragment {
                              ...
                              Bundle savedInstanceState)
    {
        ...
        ArrayList<ExploreModel> merchantList
                = Constants.getMerchanData();

        // Assign employeelist to ItemAdapter
        MerchantListAdapter itemAdapter = new MerchantListAdapter(merchantList);
