...
public class BusinessListAdapter extends RecyclerView.Adapter<BusinessListAdapter.MyViewHolder> {
    ...
    public BusinessListAdapter(ArrayList<ExploreModel> emplist) {
        this.emplist = emplist;
    }

    // This method creates a new ViewHolder object for each item in the RecyclerView
    @Override
    public BusinessListAdapter.MyViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        // Inflate the layout for each item and return a new ViewHolder object
        View itemView = LayoutInflater.from(parent.getContext()).inflate(R.layout.item_business_list, parent, false);

        return new BusinessListAdapter.MyViewHolder(itemView);
    ...
    @Override
    public void onBindViewHolder(BusinessListAdapter.MyViewHolder holder, int position) {
